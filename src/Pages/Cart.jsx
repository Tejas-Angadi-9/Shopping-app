...
const Cart = () => {
  ...
  return (
    <div className="mb-10 px-[25px]">
      {cart.length > 0 ? (
        <div className="flex justify-around item-center mt-14">
          ...
          <div className="mr-20 mt-14">
            ...
            <div>
              ...
              <button
                type="button"
                class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-[20px] px-5 py-2.5 text-center mr-2 mb-2 mt-5">
                Checkout Now
              </button>
            </div>
          </div>
